	    ...
	    <div class="collapse navbar-collapse" id="navbarSupportedContent">
	      <ul class="navbar-nav me-auto mb-2 mb-lg-0">
	        ...
	        <li class="nav-item dropdown">
	          ...
	          <ul class="dropdown-menu">
	            <li><a class="dropdown-item" href="?page=cadastrar-prescricao">Cadastrar</a></li>
	            <li><a class="dropdown-item" href="?page=listar-prescricao">Listar</a></li>
	          </ul>
	        </li>
		...
		<div class="row mt-3">
			<div class="col">
				<?php
					...
					// Switch para carregar as páginas conforme a opção
					switch (@$_REQUEST['page']) {
						...
						case 'cadastrar-prescricao':
							include('cadastrar-prescricao.php');
							break;
						case 'editar-prescricao':
							include('editar-prescricao.php');
							break;
						case 'listar-prescricao':
							include('listar-prescricao.php');
							break;
						case 'salvar-prescricao':
							include('salvar-prescricao.php');
							break;

						case 'cadastrar-pagamento':
							include('cadastrar-pagamento.php');
							break;
						case 'listar-pagamento':
							include('listar-pagamento.php');
							break;
